    ...
    <div className="rounded-2xl p-8 shadow-xl bg-white dark:bg-gray-900 mb-6 border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-2xl">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div className="flex-1">
          <h1 className="text-4xl font-display font-bold tracking-tight text-red-700 dark:text-red-400 mb-3">
          ...
          {streak > 0 && (
            <div className="flex items-center gap-3">
              <Badge className="px-3 py-1 bg-red-700 text-white border-0 shadow-md hover:shadow-lg transition-all duration-300">
